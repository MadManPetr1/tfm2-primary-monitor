...
# This generated, ignored copy keeps Cargo's dependency path portable without
# publishing third-party SDK source as part of this repository.
...
Copy-Item -LiteralPath (Join-Path $PSScriptRoot 'target/release/tfm2_primary_monitor.dll') `
    -Destination (Join-Path $PSScriptRoot 'tfm2_primary_monitor.dll') -Force
Write-Host 'Built Primary Monitor with the Stable API.'
